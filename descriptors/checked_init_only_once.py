...
if __name__ == '__main__':
    ...
    class Restricted(object):
        ...
        def __init__(self):
            if Restricted.first:
                Restricted.first = False
                for value, name in enumerate('abc'):
                    setattr(Restricted, name, value)

    restricted = Restricted()
    print(restricted.a, restricted.b, restricted.c)
    restricted2 = Restricted()
    print(restricted2.a, restricted2.b, restricted2.c)
